...
import time
import streamlit as st
st.set_page_config(page_title=" Anbarasu Dashboard",page_icon="/Users/arasu/Streamlit-Dashboard-Descriptive-Analytics-with-MYSQL-main/data/IM.png",layout="wide")
...
#side bar
st.sidebar.image("data/logo1.png",caption="Developed and Maintaned By: Anbarasu K ")
